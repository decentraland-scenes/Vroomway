import type BoidEntity from './GridEntity'

// import BoidVisibleEntity from './BoidVisibleEntity.js'
// import { BOID_CONFIG } from './Constants.js'
import type Grid from './Grid'
import { type GridEntityMgr } from './IGridEntity.js'
import type IGridEntity from './IGridEntity.js'
...
export default class GridEntity implements IGridEntity {
   ...
   */
  checkVelocity(maxVelocity = 1): void {
...
export function createGridEntity(
  type: number,
  id: string,
  position: Vector3,
  ent: GridEntityMgr,
