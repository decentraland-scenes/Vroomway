...
import { type PlayerAvatar } from '../modules/avatar/avatarSwap'
...
import { type WorldMoveVehicle } from './worldMoveVehicle'
...
export class WorldState {
  ...
  currentActiveCells = new Map<string, IGridEntity>()
  ...
  updateWithSceneConf(sceneConf: SceneConfig): void {
    ...
    this.respsawnPosY =
      tiledata.tileset_origin[tileSetIdx.y] + gridData.gridSizeMeters.y + 10
